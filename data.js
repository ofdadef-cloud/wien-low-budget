...
{
  id: 2016,
  name: 'Café Landtmann – Kaffee ab 3,00 €',
  category: 'deals',
  address: 'Ringstraße 12',
  district: '1010 Wien',
  lat: 48.2083,
  lng: 16.3731,
  description: 'Im Café Landtmann können Sie Kaffee ab 3,00 € genießen. Das traditionsreiche Café ist ein beliebter Treffpunkt für Kulturinteressierte und bietet eine gemütliche Atmosphäre.',
  priceInfo: 'Kaffee ab 3,00 €',
...
{
  id: 2017,
  name: 'Theater in der Josefstadt – Stehplätze ab 12 €',
  category: 'deals',
  address: 'Josefstadt 12',
  district: '1080 Wien',
  lat: 48.2133,
  lng: 16.3531,
  description: 'Im Theater in der Josefstadt können Sie Stehplätze für 12–18 € erwerben. Die Stehplätze sind etwa 80 Minuten vor Vorstellungsbeginn an der Abendkasse erhältlich.',
  priceInfo: 'Stehplatz: 12–18 € (Abendkasse)',
  website: 'https://www.theater-josefstadt.at/',
  lastUpdated: '2026-08-07',
  tags: ['theater', 'stehplatz', 'täglich', 'kultur', 'günstig']
},
{
  id: 2018,
  name: 'Neues Theater – Happy Hour',
  category: 'deals',
  address: 'Neubaugasse 1',
  district: '1070 Wien',
  lat: 48.2022,
  lng: 16.3511,
  description: 'Im Neuen Theater gibt es täglich eine Happy Hour, bei der Cocktails zu Studentenpreisen und Bier ab 2,50 € angeboten werden. Die Bar öffnet täglich um 15 Uhr und schließt um 6 Uhr früh.',
  priceInfo: 'Bier ab 2,50 € · Happy Hour täglich',
  website: '',
  lastUpdated: '2026-08-07',
  tags: ['theater', 'happy-hour', 'täglich', 'studenten', 'günstig']
},
{
  id: 2019,
  name: 'Café Mozart – Kaffee ab 2,80 €',
  category: 'deals',
  address: 'Albertinaplatz 2',
  district: '1010 Wien',
  lat: 48.2033,
  lng: 16.3692,
  description: 'Im Café Mozart können Sie Kaffee ab 2,80 € genießen. Das traditionsreiche Café ist ein beliebter Treffpunkt für Kulturinteressierte und bietet eine gemütliche Atmosphäre.',
  priceInfo: 'Kaffee ab 2,80 €',
...
{
  id: 2020,
  name: 'Restaurant Ofenloch – Mittagstisch ab 8,90 €',
  category: 'deals',
  address: 'Kärntner Straße 21',
  district: '1010 Wien',
  lat: 48.2033,
  lng: 16.3731,
  description: 'Im Restaurant Ofenloch können Sie den Mittagstisch ab 8,90 € genießen. Das Restaurant bietet eine gemütliche Atmosphäre und eine Vielzahl an Gerichten.',
  priceInfo: 'Mittagstisch ab 8,90 €',
  website: 'https://www.ofenloch.at/',
  lastUpdated: '2026-08-07',
...
},
{
  ...
  lat: 48.1968,
  lng: 16.3650,
  description: 'Ein legendäres Wiener Nachtkaffeehaus am Naschmarkt, bekannt für seine günstigen Bieren und gemütliche Atmosphäre. Beliebt bei Studenten und Nachtschwärmern, geöffnet bis 4 Uhr. Ideal für einen späten Abend mit Freunden.',
  priceInfo: 'Bier ab ~3 €',
  website: '',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.2380,
  lng: 16.3800,
  description: 'Eine Cocktail- und Karaoke-Bar in der Millennium City, ideal für einen unvergesslichen Abend. Am Freitag und Samstag gibt es Cocktails ab 1,80 €. Eine gute Adresse für Gruppen und Feiern.',
  priceInfo: 'Cocktails ab 1,80 € (Fr/Sa)',
  website: 'http://www.soho-vienna.at',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.1945,
  lng: 16.3560,
  description: 'Eine alternative, queere Bar mit Partykeller, Vernissagen, Karaoke und Performances. Gute Musik, gute Stimmung, Tischfußball und kleine Snacks wie Tacos/Burritos. Ein Hotspot für die LGBTQ+-Community.',
 ...
 
{
  ...
  lat: 48.1985,
  lng: 16.3430,
  description: 'Top-Adresse für günstige Drinks und lange Nächte. Beliebt bei Reisenden und Studenten. Tolle Stimmung, billige Cocktails und eine gemütliche Atmosphäre.',
 ...
 
{
  ...
  lat: 48.2010,
  lng: 16.3500,
  description: 'Klassiker unter den Studentenlokalen im 7. Bezirk. Gemütlich, günstig und mit Happy Hours. Bier ab 2,50 €. Täglich ab 15 Uhr bis 6 Uhr früh! Ein Muss für Studenten und Nachtschwärmer.',
 ...
 
{
  ...
  lat: 48.2020,
  lng: 16.3510,
  description: 'Eine gemütliche Kaffeebar mit einer großen Auswahl an Kaffeespezialitäten und kleinen Snacks, ideal zum Entspannen und den Tag beginnen. Ein ruhiger Ort inmitten der Stadt.',
 ...
 
{
  ...
  lat: 48.1930,
  lng: 16.3810,
  description: 'Eine trendige Bar mit einer großen Auswahl an Cocktails und einer gemütlichen Atmosphäre, ideal zum Abend verbringen und neue Leute kennenlernen. Ein Hotspot für junge Erwachsene.',
 ...
 
{
  ...
  lat: 48.2183,
  lng: 16.3903,
  description: 'Ein Ort für kulturelle Veranstaltungen, günstige Getränke und eine entspannte Atmosphäre, ideal zum Entspannen und die kulturelle Szene Wiens erleben. Einzigartige Events und Ausstellungen.',
 ...
 
{
  ...
  name: 'Rhiz',
  category: 'bars',
  address: 'U-Bahn-Station U6 - Josefstädter Straße',
  district: '1060 Wien',
  lat: 48.2083,
  lng: 16.3367,
  description: 'Ein einzigartiger Ort für kulturelle Veranstaltungen, günstige Getränke und eine entspannte Atmosphäre in einem ehemaligen U-Bahn-Tunnel. Experimentelle Kunst und Musik.',
  priceInfo: 'Bier ab ~3,50 €',
 ...
 
{
  ...
  lat: 48.2133,
  lng: 16.3533,
  description: 'Eine stilvolle Bar mit einer großen Auswahl an Cocktails und einer atemberaubenden Aussicht auf die Stadt, ideal zum Abend verbringen und die Stadt genießen. Luxuriöse Atmosphäre und hochwertige Getränke.',
  priceInfo: 'Cocktails ab ~8 €',
  website: 'https://dasloft.at/',
  lastUpdated: '2026-08-07',
  tags: ['cocktails', 'stilvoll', 'aussicht']
},
 
{
  ...
  lat: 48.1935,
  lng: 16.3815,
  description: 'Eine trendige Bar mit einer großen Auswahl an Craft-Bieren und einer gemütlichen Atmosphäre, ideal zum Abend verbringen und neue Leute kennenlernen. Bierliebhaber kommen hier voll auf ihre Kosten.',
  priceInfo: 'Bier ab ~5 €',
  website: 'https://thesign.bar/',
  lastUpdated: '2026-08-07',
  tags: ['craft-bier', 'trendy', 'gemütlich']
},
...
},
{
  ...
  // ─── UNTERKÜNFTE ─────────────────────────────────────────
  {
    ...
    lat: 48.1966,
    lng: 16.3385,
    description: 'Modernes Hostel direkt im IKEA am Westbahnhof mit Dachterrasse und lebendigem Social-Vibe. Ideal für junge Reisende, die Wert auf eine zentrale Lage und eine gute Verbindung zu den öffentlichen Verkehrsmitteln legen. Die Zimmer sind modern eingerichtet und es gibt eine Gemeinschaftsküche.',
  ...
  },
  {
    ...
    lat: 48.1916,
    lng: 16.3383,
    description: 'Familiäres Hostel mit Gemeinschaftsküche und hauseigenem Garten. Perfekt für Solo-Traveller und Reisende, die Wert auf eine ruhige Atmosphäre legen und sich selbst verpflegen möchten. Es gibt auch eine Lounge mit TV und eine Bibliothek.',
  ...
  },
  {
    ...
    lat: 48.1798,
    lng: 16.3768,
    description: 'Party-Hostel südlich des Hauptbahnhofs mit hauseigener Belushi\'s Bar und günstigen Drinks. Ideal für Reisende, die Wert auf eine lebendige Atmosphäre legen und gerne feiern. Es gibt auch eine Gemeinschaftsküche und eine Lounge.',
  ...
  },
  {
    ...
    lat: 48.1970,
    lng: 16.3620,
    description: 'Klassisches Hostel in Top-Lage direkt am Naschmarkt mit legendärer WomBar. Perfekt für Reisende, die Wert auf eine zentrale Lage und eine gute Verbindung zu den öffentlichen Verkehrsmitteln legen. Es gibt auch eine Gemeinschaftsküche und eine Lounge.',
  ...
  },
  {
    ...
    lat: 48.2223,
    lng: 16.3687,
    description: 'Guter Mix aus Hotel und Hostel im hippen 2. Bezirk mit sauberen Zimmern und professioneller Führung. Ideal auch für kleine Gruppen, die Wert auf eine gute Ausstattung legen. Es gibt auch eine Gemeinschaftsküche und eine Lounge.',
  ...
  },
  {
    ...
    lat: 48.1850,
    lng: 16.3770,
    description: 'Riesiges und verlässliches Budget-Hostel direkt hinter dem Hauptbahnhof mit funktionellen Zimmern und günstigen Betten im Dorm. Ideal für Reisende, die Wert auf eine gute Verbindung zu den öffentlichen Verkehrsmitteln legen. Es gibt auch eine Gemeinschaftsküche und eine Lounge.',
  ...
  },
  {
    ...
    lat: 48.1922,
    lng: 16.3356,
    description: 'Einfaches, aber sauberes Hostel in einem ruhigen Viertel. Ideal für Budget-Reisende, die Wert auf eine gute Nachtruhe legen und sich selbst verpflegen möchten. Es gibt auch eine Gemeinschaftsküche.',
  ...
  {
    id: 37,
    name: 'Hostel Hütteldorf',
    category: 'unterkunft',
    address: 'Hütteldorfer Straße 80',
    district: '1140 Wien',
    lat: 48.2033,
    lng: 16.2667,
    description: 'Gemütliches Hostel im 14. Bezirk mit guter Anbindung an das Stadtzentrum durch öffentliche Verkehrsmittel. Ideal für Reisende, die Wert auf eine ruhige Atmosphäre legen und sich selbst verpflegen möchten. Es gibt auch eine Gemeinschaftsküche.',
    priceInfo: 'Ab ~20 € / Nacht',
  ...
  },
  {
    ...
    lat: 48.2083,
    lng: 16.3731,
    description: 'Modernes und stylisches Hostel im Zentrum von Wien mit Dachterrasse und lebendigem Social-Vibe. Ideal für junge Reisende, die Wert auf eine zentrale Lage und eine gute Verbindung zu den öffentlichen Verkehrsmitteln legen. Es gibt auch eine Gemeinschaftsküche und eine Lounge.',
    priceInfo: 'Ab ~25 € / Nacht',
  ...
  },
  {
    ...
    lat: 48.2023,
    lng: 16.2657,
    description: 'Charmantes Hostel im 14. Bezirk mit guter Anbindung an das Stadtzentrum durch öffentliche Verkehrsmittel. Ideal für Reisende, die Wert auf eine ruhige Atmosphäre legen und sich selbst verpflegen möchten. Es gibt auch eine Gemeinschaftsküche.',
    priceInfo: 'Ab ~22 € / Nacht',
  ...
  },
  {
    ...
    category: 'unterkunft',
    address: 'Lindengasse 5',
    district: '1070 Wien',
    lat: 48.2042,
    lng: 16.3367,
    description: 'Zentrales Hostel im 7. Bezirk mit modernen Zimmern und einer Gemeinschaftsküche. Ideal für Reisende, die Wert auf eine gute Verbindung zu den öffentlichen Verkehrsmitteln legen. Es gibt auch eine Lounge mit TV.',
    priceInfo: 'Ab ~23 € / Nacht',
    website: 'https://www.hosteldowntown.at',
    lastUpdated: '2026-08-07',
    tags: ['hostel', 'zentral', 'modern']
  },
 ...
 
{
  ...
  lat: 48.2000,
  lng: 16.3390,
  description: 'Türkische Bäckerei mit 24-Stunden-Öffnungszeit, bietet frisches Gebäck und Brot wie Simit und Börek, sowie türkische Süßigkeiten. Ideal für späte Einkäufe oder ein schnelles Frühstück. Preise ab 1,50 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.1960,
  lng: 16.3580,
  description: 'Türkische 24h-Bäckerei an der Wienzeile, bietet eine Vielzahl an frischem Gebäck und Brot wie Simit, Börek und Lahmacun. Ideal für späte Einkäufe oder ein schnelles Frühstück. Preise ab 2 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
  tags: ['bäckerei', '24h', 'türkisch']
 ...
 
{
  ...
  lat: 48.2120,
  lng: 16.3370,
  description: 'Türkische Bäckerei am Brunnenmarkt mit 24-Stunden-Betrieb, bietet eine Vielzahl an frischem Gebäck und Brot wie türkisches Fladenbrot und Süßigkeiten. Beliebte Spezialitäten sind die türkischen Süßigkeiten und das frische Brot. Preise ab 1,50 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.2130,
  lng: 16.3360,
  description: 'Weitere 24h-Bäckerei in der Brunnengasse, bekannt für authentisches türkisches Brot und Gebäck wie türkisches Fladenbrot und Simit. Bietet eine Vielzahl an frischem Gebäck und Brot. Preise ab 2 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
  tags: ['bäckerei', '24h', 'brunnenmarkt']
 ...
 
{
  ...
  lat: 48.1990,
  lng: 16.3380,
  description: 'Türkische Bäckerei mit frischem Gebäck und Brot, ideal für einen schnellen Snack oder ein Mittagessen. Bietet eine Vielzahl an türkischen Spezialitäten wie Lahmacun und Börek. Preise ab 2 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.1940,
  lng: 16.3510,
  description: 'Türkische Bäckerei mit einer großen Auswahl an Gebäck und Brot, zentral gelegen in der Mariahilfer Straße. Bietet eine Vielzahl an frischem Gebäck und Brot wie Simit und Kekse. Preise ab 2,50 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
  tags: ['bäckerei', 'türkisch']
 ...
 
{
  ...
  category: 'baeckerei',
  address: 'Wienzeile 12',
  district: '1050 Wien',
  lat: 48.1950,
  lng: 16.3570,
  description: 'Türkische Bäckerei mit frischem Gebäck und Brot, ideal für einen schnellen Snack oder ein Mittagessen. Bietet eine Vielzahl an türkischen Spezialitäten wie Baklava und Knafeh. Preise ab 2,50 €.',
  priceInfo: 'Günstig',
  website: '',
  lastUpdated: '2026-08-07',
  tags: ['bäckerei', 'türkisch']
...
{
  id: 69,
  name: 'Bäckerei Sultan',
  category: 'baeckerei',
  address: 'Gumpendorfer Straße 10',
  district: '1060 Wien',
  lat: 48.1930,
  lng: 16.3490,
  description: 'Türkische Bäckerei mit frischem Gebäck und Brot, ideal für einen schnellen Snack oder ein Mittagessen. Bietet eine Vielzahl an türkischen Spezialitäten wie Lahmacun und Börek. Preise ab 2 €.',
...
// ─── KINO ────────────────────────────────────────────────
  ...
  lat: 48.2082,
  lng: 16.3738,
  description: 'Gratis Freiluftkino an wechselnden Plätzen in Wien – jedes Sommer-Highlight! Zeigt internationale Arthouse-Filme und Klassiker unter freiem Himmel. Besucher sollten vorher die Website checken, um den aktuellen Standort zu erfahren.',
  priceInfo: 'Gratis',
 ...
 
{
  ...
  category: 'kino',
  address: 'Augarten (Obere Augartenstraße 1)',
  district: '1020 Wien',
  lat: 48.2230,
  lng: 16.3792,
  description: 'Beliebtes Open-Air-Kino im Augarten, jeden Sommer im Juli/August. Film beginnt nach Einbruch der Dunkelheit (~21:30 Uhr). Decken mitbringen und unter den Sternen entspannen! Es gibt auch Snack- und Getränkestände vor Ort.',
 ...
 
{
  ...
  lat: 48.2106,
  lng: 16.3589,
  description: 'Jedes Jahr Juli–September: Gratis Open-Air-Kinoleinwand am Rathausplatz mit täglich wechselndem Programm (Konzertaufzeichnungen, Oper, Film). Umrahmt von zahlreichen Food-Ständen aus aller Welt. Ein perfekter Ort, um Kultur und Essen zu genießen.',
  priceInfo: 'Gratis',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.1922,
  lng: 16.3622,
  description: 'Kultiges Arthouse-Kino im 5. Bezirk. Zeigt unabhängige und internationale Filme, die man im Multiplex vergeblich sucht. Toller kleiner Kinosaal mit gutem Sitzkomfort. Montag-Specials oft günstiger! Studenten und Senioren erhalten Ermäßigungen.',
 ...
 
{
  ...
  lat: 48.1953,
  lng: 16.3444,
  description: 'Verstecktes Kellerkino im 6. Bezirk mit Fokus auf queeres Kino, Doku-Filme und experimentelles Kino. Sehr angesagtes Programmkino mit Kulturveranstaltungen. Oft günstige Abonnements. Einzigartige Atmosphäre und eine gute Auswahl an unabhängigen Filmen.',
 ...
 
{
  ...
  lat: 48.2211,
  lng: 16.3544,
  description: 'Eines der ältesten noch betriebenen Kinos Wiens (seit 1912!). Tolles Programmkino im 9. Bezirk nahe dem Votivpark – internationale Filme, Retrospektiven und Filmreihen. Historisches Ambiente und eine gute Akustik.',
 ...
 
{
  ...
  name: 'Haydn Kino',
  category: 'kino',
  address: 'Mariahilfer Straße 57',
  district: '1060 Wien',
  lat: 48.1978,
  lng: 16.3482,
  description: 'Kleines, familiäres Kino direkt an der Mariahilfer Straße. Zeigt englischsprachige OV-Filme und Blockbuster. Beliebt bei Expats und Englischsprachigen in Wien. Gute Sitzplätze und eine angenehme Atmosphäre.',
  priceInfo: 'Ab 9,50 €',
 ...
 
{
  ...
  lat: 48.2122,
  lng: 16.3778,
  description: 'Kulturzentrum direkt am Donaukanal mit Kino, Planetarium und Veranstaltungen. Das Kino zeigt abwechslungsreiche Programme. Tolle Terrasse mit Blick auf den Donaukanal – Kinoeintritt + Aussicht! Ein perfekter Ort, um Kultur und Natur zu genießen.',
...
{
  id: 308,
  name: 'Arena Kino (Open Air im Sommer)',
  category: 'kino',
  address: 'Baumgasse 80',
  district: '1030 Wien',
  lat: 48.1935,
  lng: 16.4039,
  description: 'Das Kulturareal Arena im 3. Bezirk hat im Sommer ein Open-Air-Kino! Konzerte, Festivals und Filmvorführungen in einem ehemaligen Schlachthof-Gelände. Einzigartiges Ambiente für Konzert- und Kinobesuche. Gute Auswahl an Getränken und Snacks.',
...
{
  id: 309,
  name: 'Sommernachtkonzert Schönbrunn',
  category: 'kino',
  address: 'Schlosspark Schönbrunn',
  district: '1130 Wien',
  lat: 48.1845,
  lng: 16.3122,
  description: 'Jedes Jahr im Mai/Juni: Die Wiener Philharmoniker spielen ein GRATIS Open-Air-Konzert im Schlosspark Schönbrunn. Eines der größten Gratis-Klassik-Events weltweit! Einfach hinsetzen, Picknick mitbringen und genießen. Früh kommen, um gute Plätze zu sichern.',
  priceInfo: 'GRATIS',
  lastUpdated: '2026-08-07',
 ...
 
{
  ...
  lat: 48.2028,
  lng: 16.3690,
  description: 'Weltklasse-Oper ab 13 € mit Stehplatz! Ca. 80 Minuten vor Vorstellungsbeginn anstellen. Balkon-Stehplätze bieten sogar gute Sicht. Ein Muss für Kulturliebhaber mit kleinem Budget. Parterre-Stehplätze kosten 13 €, Balkon-Stehplätze 17 €.',
 ...
 
{
  ...
  lat: 48.1942,
  lng: 16.3462,
  description: 'Gemütliches Café mit großem Angebot an Kaffee, Kuchen und Frühstück. Perfekt für ein entspanntes Frühstück oder einen Kaffee, wie z.B. Frühstück ab 6 €. Die freundliche Atmosphäre und die fairen Preisen machen es zu einem beliebten Treffpunkt.',
